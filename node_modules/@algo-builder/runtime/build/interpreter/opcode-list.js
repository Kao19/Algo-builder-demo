...
class Txn extends opcode_1.Op {
    ...
    constructor(args, line, interpreter) {
        ...
        if (constants_1.TxArrFields[interpreter.tealVersion].has(args[0])) {
            // eg. txn Accounts 1
            (0, parsing_1.assertLen)(args.length, 2, line);
            (0, parsing_1.assertOnlyDigits)(args[1], line);
...
class Gtxn extends opcode_1.Op {
    ...
    execute(stack) {
        ...
        if (this.txFieldIdx !== undefined) {
            ...
            result = (0, txn_1.txnSpecByField)(this.field, tx, this.groupTxn, this.interpreter.tealVersion);
        }
        stack.push(result);
        return this.computeCost();
    }
...
class ByteAdd extends ByteOp {
    execute(stack) {
        return super.execute(stack, 0 /* Add */);
    }
}
...
class ByteSub extends ByteOp {
    execute(stack) {
        return super.execute(stack, 1 /* Sub */);
    }
}
...
class ByteMul extends ByteOp {
    execute(stack) {
        return super.execute(stack, 2 /* Mul */);
    }
}
...
class ByteDiv extends ByteOp {
    execute(stack) {
        return super.execute(stack, 3 /* Div */);
    }
}
...
class ByteMod extends ByteOp {
    execute(stack) {
        return super.execute(stack, 4 /* Mod */);
    }
}
...
class ByteGreaterThan extends ByteOp {
    execute(stack) {
        return super.execute(stack, 6 /* GreaterThan */);
    }
}
...
class ByteLessThan extends ByteOp {
    execute(stack) {
        return super.execute(stack, 5 /* LessThan */);
    }
}
...
class ByteGreaterThanEqualTo extends ByteOp {
    execute(stack) {
        return super.execute(stack, 8 /* GreaterThanEqualTo */);
    }
}
...
class ByteLessThanEqualTo extends ByteOp {
    execute(stack) {
        return super.execute(stack, 7 /* LessThanEqualTo */);
    }
}
...
class ByteEqualTo extends ByteOp {
    execute(stack) {
        return super.execute(stack, 9 /* EqualTo */);
    }
}
...
class ByteNotEqualTo extends ByteOp {
    execute(stack) {
        return super.execute(stack, 10 /* NotEqualTo */);
    }
}
...
class ByteBitwiseOr extends ByteOp {
    execute(stack) {
        return super.execute(stack, 11 /* BitwiseOr */);
    }
}
...
class ByteBitwiseAnd extends ByteOp {
    execute(stack) {
        return super.execute(stack, 12 /* BitwiseAnd */);
    }
}
...
class ByteBitwiseXor extends ByteOp {
    execute(stack) {
        return super.execute(stack, 13 /* BitwiseXor */);
    }
}
...
class Bsqrt extends opcode_1.Op {
    ...
    execute(stack) {
        ...
        // convert to bigint
        const bigintValue = (0, parsing_1.bigEndianBytesToBigInt)(value);
        // compute sqrt
        const bigintResult = (0, math_1.bigintSqrt)(bigintValue);
        stack.push((0, parsing_1.bigintToBigEndianBytes)(bigintResult));
        return this.computeCost();
    }
}
exports.Bsqrt = Bsqrt;
...
class EcdsaVerify extends opcode_1.Op {
    ...
    computeCost() {
        return constants_1.OpGasCost[5]["ecdsa_verify"];
    }
    /**
...
class EcdsaPkDecompress extends opcode_1.Op {
    ...
    computeCost() {
        return constants_1.OpGasCost[6]["ecdsa_pk_decompress"];
    }
    /**
...
class EcdsaPkRecover extends opcode_1.Op {
    ...
    computeCost() {
        return constants_1.OpGasCost[6]["ecdsa_pk_recover"];
    }
    /**
...
class ITxn extends opcode_1.Op {
    ...
    constructor(args, line, interpreter) {
        ...
        if (constants_1.TxArrFields[interpreter.tealVersion].has(args[0]) ||
            constants_1.ITxArrFields[interpreter.tealVersion].has(args[0])) {
            // eg. itxn Accounts 1
            (0, parsing_1.assertLen)(args.length, 2, line);
            (0, parsing_1.assertOnlyDigits)(args[1], line);
            this.idx = Number(args[1]);
...
class AcctParamsGet extends opcode_1.Op {
    ...
    constructor(args, line, interpreter) {
        ...
        this.interpreter = interpreter;
        (0, parsing_1.assertLen)(args.length, 1, line);
        if (!constants_1.AcctParamQueryFields[args[0]] ||
            constants_1.AcctParamQueryFields[args[0]].version > interpreter.tealVersion) {
...
class Base64Decode extends opcode_1.Op {
    ...
    execute(stack) {
        ...
        switch (this.encoding) {
            case "base64url":
                (0, parsing_1.assertBase64Url)((0, parsing_1.convertToString)(last), this.line);
                break;
            case "base64":
                (0, parsing_1.assertBase64)((0, parsing_1.convertToString)(last), this.line);
                break;
        }
