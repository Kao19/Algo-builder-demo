 ...
 */
export declare function opcodeFromSentence(words: string[], counter: number, interpreter: Interpreter, mode: ExecutionMode): Op;
/**
 ...
 * @param interpreter: interpreter object
 */
export declare function parser(program: string, mode: ExecutionMode, interpreter: Interpreter): Op[];
export declare function isAddIntcblock(ops: Op[], interpreter: Interpreter): boolean;
export declare function isAddedBytecblock(ops: Op[], interpreter: Interpreter): boolean;
/**
 *
 * @param program teal program
 * @returns pragma version of this file
 */
export declare function getProgramVersion(program: string): number;
