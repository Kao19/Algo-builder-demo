...
function printSuggestedCommands() {
    const npx = (0, execution_mode_1.getExecutionMode)() === execution_mode_1.ExecutionMode.EXECUTION_MODE_GLOBAL_INSTALLATION ? "" : "npx ";
...
async function createProject(location, isTSProject, withInfrastucture) {
...
async function installRecommendedDependencies() {
    ...
    return ((await installDependencies(installDevDependCmd[0], installDevDependCmd.slice(1))) &&
...
async function installDevDependenciesCmd() {
...
async function installDependenciesCmd() {
    const isGlobal = (0, execution_mode_1.getExecutionMode)() === execution_mode_1.ExecutionMode.EXECUTION_MODE_GLOBAL_INSTALLATION;
