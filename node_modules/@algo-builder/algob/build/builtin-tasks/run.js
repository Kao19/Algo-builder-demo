...
async function executeRunTask({ scripts }, runtimeEnv, algoOp) {
    ...
    await runMultipleScripts(runtimeEnv, (0, files_1.assertDirChildren)(script_checkpoints_1.scriptsDirectory, scripts), (_cpData, _relativeScriptPath) => { }, // eslint-disable-line @typescript-eslint/no-empty-function
    true, logDebugTag, false, algoOp);
}
function default_1() {
