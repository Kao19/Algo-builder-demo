...
export declare class CompileOp {
     ...
     */
    ensureCompiled(filename: string, tealSource?: string, force?: boolean, scTmplParams?: SCParams): Promise<ASCCache>;
    ...
    compile(filename: string, tealCode: string, tealHash: number, scParams: SCParams): Promise<ASCCache>;
