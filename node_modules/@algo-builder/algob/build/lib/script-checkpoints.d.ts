 ...
 */
export declare function registerCheckpoints(deployer: Deployer, execParams: wtypes.ExecParams[], txns: Transaction[], txIdxMap: Map<number, [string, wtypes.ASADef]>): Promise<void>;
