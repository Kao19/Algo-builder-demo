...
function fromMnemonic(ia) {
    ...
    if (a.addr !== ia.addr && ia.addr !== "") {
        throw new web_1.BuilderError(web_1.ERRORS.ACCOUNT.MNEMONIC_ADDR_MISSMATCH, {
            name: ia.name,
            addr: ia.addr,
...
function loadAccountsFromEnv() {
    ...
    if (algobAccountsString) {
        ...
        try {
            ...
            throw new web_1.BuilderError(web_1.ERRORS.ACCOUNT.MALFORMED, {
                errors: "Some accounts are malformed or have missing fields",
            });
        }
        ...
        for (const account of accounts) {
            try {
                ...
                throw new web_1.BuilderError(web_1.ERRORS.ACCOUNT.WRONG_MNEMONIC, {
...
function validateAccounts(algobAccounts) {
    for (const account of algobAccounts) {
        if (account.name === undefined) {
            throw new web_1.BuilderError(web_1.ERRORS.ACCOUNT.FIELD_REQUIRED, {
